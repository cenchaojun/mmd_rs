...
simple_hist(img_sizes, [0, 200, 500, 750, 1000, 10000], fig_name='img_sizes')
simple_hist(img_ratios, [0, 0.5, 1, 1.5, 2], fig_name='img_ratios')
simple_hist(bbox_per_imgs, [0, 1,2, 3, 5, 10, 20, 50, 10000], fig_name='bbox_per_imgs')
