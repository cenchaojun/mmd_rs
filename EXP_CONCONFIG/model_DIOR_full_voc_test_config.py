...
def gen_dict(name, config,
             ...
             epoch=24,
             result_name='ms_test_results.pkl'):
    ...
    return dict(
        ...
        dota_eval_results= work_dir + '/ms_test_eval_results.txt',
        type='HBB'
    )

DIOR_root = './DOTA_configs/DIOR_ms_test'
DIOR_ms_test_cfgs = [
...
DIOR_ms_test_cfgs = {cfg.pop('name'):cfg for cfg in DIOR_ms_test_cfgs}