...
class DeltaXYWHADBBoxCoderRS(BaseBBoxCoder):
    ...
    def encode(self, rbboxes, gt_rbboxes):
        ...
        Args:
            ...
            anchors, or sth.. n x 5 or n x 4
            n x 5 -> [x, y, w, h, a]
            gt_rbboxes (torch.Tensor): Target of the transformation, e.g.,
                ground-truth boxes.
            n x 5 -> [x, y, w, h, a]
