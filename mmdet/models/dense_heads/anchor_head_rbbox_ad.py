...
from mmdet.core import (AnchorGeneratorAD, anchor_target_rbbox,
                        delta2dbbox, delta2dbbox_v3, multi_apply, multiclass_nms,
                        multiclass_nms_rbbox)
from mmdet.core.bbox.transforms_rbbox_ad import hbb2obb_v2
...
class AnchorHeadRbbox(nn.Module):
    ...
    def __init__(self,
        ...
        self.sampling = loss_cls['type'] not in ['FocalLossOld', 'GHMC']
        ...
        for anchor_base in self.anchor_base_sizes:
            self.anchor_generators.append(
                AnchorGeneratorAD(anchor_base, anchor_scales, anchor_ratios))
