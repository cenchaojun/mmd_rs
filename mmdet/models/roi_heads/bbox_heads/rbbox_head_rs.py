...
class RbboxHeadRS(nn.Module):
    ...
    def __init__(self,
        ...
        super(RbboxHeadRS, self).__init__()
    ...
    def _get_target_single(self, pos_bboxes, neg_bboxes, pos_gt_rbboxes,
                           pos_gt_labels, cfg):
        """

        :param pos_bboxes:    正anchor
        :param neg_bboxes:
        :param pos_gt_rbboxes:
        :param pos_gt_labels:
        :param cfg:
        :return:
        """
        ...
        if num_pos > 0:
            ...
            if not self.reg_decoded_bbox:
                pos_bbox_targets = self.bbox_coder.encode(
                    pos_bboxes, pos_gt_rbboxes)
            else:
                pos_bbox_targets = pos_gt_rbboxes
